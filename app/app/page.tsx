...
export default function MobileAppPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] sm:bg-gradient-to-br sm:from-[#0D1210] sm:via-[#141A17] sm:to-[#0A0E0C] py-0 sm:py-8 flex justify-center selection:bg-emerald-800 selection:text-white">
      
      {/* 📱 KHUNG MÁY IPHONE 17 PRO MAX TITANIUM (VIỀN SIÊU MỎNG 1.15MM) */}
      <div className="w-full sm:max-w-[400px] min-h-screen sm:min-h-[860px] sm:max-h-[880px] sm:rounded-[52px] bg-[#FAF8F5] text-stone-900 antialiased sm:shadow-[0_25px_90px_-10px_rgba(0,0,0,0.85),0_0_0_2px_#383B3F] sm:border-[2px] border-stone-600 relative overflow-y-auto overflow-x-hidden select-none pb-28 no-scrollbar">
        
        {/* ========================================================
            📱 2. APP HEADER BAR (SẮC NÉT, ĐẲNG CẤP, CÓ HỒN)
            ======================================================== */}
        <header className="sticky top-0 z-40 bg-[#FAF8F5]/95 backdrop-blur-md px-4 pt-[calc(0.75rem+env(safe-area-inset-top,0px))] pb-3 border-b border-[#E8E1D5] flex items-center justify-between shadow-3xs">
        ...
        {/* ========================================================
            ...
            ======================================================== */}
        <nav className="fixed bottom-0 left-0 right-0 w-full sm:max-w-[400px] mx-auto z-50 bg-[#FAF8F5]/95 backdrop-blur-lg border-t border-[#E0D8CB] px-2 py-1.5 flex items-center justify-around shadow-[0_-6px_25px_rgba(24,58,45,0.08)] pb-[calc(0.6rem+env(safe-area-inset-bottom,0px))] sm:rounded-b-[2.5rem]">
