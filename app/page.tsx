  ...
  return (
    <main className="min-h-screen overflow-x-hidden antialiased bg-white text-[#0A2517] pb-28 md:pb-0">
      ...
      <section className="relative w-full flex flex-col lg:flex-row items-stretch min-h-[80vh] bg-[#FAF9F6] overflow-hidden">
        {/* Left: Text & CTAs */}
        <div className="w-full lg:w-1/2 flex flex-col justify-start items-start px-4 md:px-12 lg:px-20 xl:px-24 2xl:px-32 py-16 lg:pt-[15vh] lg:pb-20 z-10 relative mt-16 lg:mt-0">
      ...
      <section className="w-full py-16 bg-[#F9F9F9]">
        {/* Mở rộng không gian để tràn viền (Full-bleed Vibe) */}
        <div className="w-full px-2 md:px-4 lg:px-6 xl:px-8 2xl:px-10">
          {/* Header Section */}
      ...
      {/* Bọc toàn bộ Section */}
      <section className="w-full px-4 md:px-12 lg:px-20 xl:px-24 2xl:px-32 py-20 bg-white border-t border-stone-100">
      ...
      <section className="w-full px-4 md:px-12 lg:px-20 xl:px-24 2xl:px-32 py-20 bg-[#F9F9F9]">
      ...
      <section className="w-full px-4 md:px-12 lg:px-20 xl:px-24 2xl:px-32 py-24 bg-[#F7F5F0]">
