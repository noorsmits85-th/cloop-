...
export default function BlogJournalPage() {
    ...
    async function fetchRealDataFeed() {
      try {
        ...
        const formattedBlogs = publicBlogs.map((blog: any) => {
          ...
          const blogInteractions = (interactionsData || []).filter((i: any) => String(i.blogId) === String(blog.id));
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#F4F1EA] flex items-center justify-center font-heading relative">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
          ...
          <div className="xl:col-span-8 bg-[url('/giaynhaurach.png')] bg-cover bg-center p-8 md:p-12 min-h-[380px] flex flex-col md:flex-row items-center justify-between gap-8 filter drop-shadow-md relative">
            ...
            <div className="space-y-5 max-w-md relative z-10">
              <h1 className="text-5xl md:text-6xl font-heading text-[#1A3B2E] font-bold leading-tight">
                BẢO TÀNG <br/>
            ...
            <div className="relative shrink-0 flex items-center gap-4 z-10 hidden md:flex">
              <div className="w-40 p-4 border border-dashed border-stone-300 bg-[#FAF8F5]/50 rotate-3 text-center">
                <p className="text-[11px] font-heading italic text-stone-700 leading-relaxed">
              ...
              <div className="bg-white p-3 pb-8 rounded-sm shadow-[0_10px_20px_rgba(0,0,0,0.1)] rotate-[-4deg] relative w-56">
                ...
                <p className="absolute bottom-2 w-full text-center text-[10px] font-heading italic text-stone-500 pr-6">Nơi lưu giữ nét đẹp</p>
              </div>
            </div>
          </div>
          ...
          <div className="xl:col-span-4 bg-[url('/giaynhaurach.png')] bg-cover bg-center p-8 min-h-[380px] flex flex-col justify-center items-center text-center filter drop-shadow-md relative">
            ...
            {currentUserId ? (
              <>
                ...
                <h2 className="text-2xl font-heading font-bold text-[#1A3B2E]">
                ...
                <div className="grid grid-cols-3 w-full gap-2 border-t border-b border-stone-300/50 py-4 mt-6 mb-5">
                  <div><p className="text-lg font-heading font-bold text-[#1A3B2E]">{myPostCount}</p><p className="text-[9px] uppercase">Câu chuyện</p></div>
                  <div><p className="text-lg font-heading font-bold text-[#1A3B2E]">{myTotalLikes}</p><p className="text-[9px] uppercase">Đồng cảm</p></div>
                  <div><p className="text-lg font-heading font-bold text-[#1A3B2E]">{myProductCount}</p><p className="text-[9px] uppercase">Trang phục</p></div>
                </div>
              ...
              <>
                ...
                <h2 className="text-2xl font-heading font-bold text-[#1A3B2E]">Chào bạn! 👋</h2>
                <p className="text-xs font-heading italic text-stone-600 mt-4 leading-relaxed px-4">
          ...
          <div className="xl:col-span-8 bg-[url('/giaynhaurach.png')] bg-cover bg-center p-8 filter drop-shadow-md relative">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-8 border-b border-stone-300/50 pb-4">
              <div className="text-left pl-8">
                <h2 className="text-2xl font-heading font-bold text-[#1A3B2E] flex items-center gap-2">
                  🌿 BẢNG KÝ ỨC
                </h2>
              </div>
                    ...
                    <div className="bg-[#FAF9F6] p-3 pb-4 rounded-sm shadow-md border border-stone-200 flex flex-col h-full relative">
                      ...
                      <div className="flex-1 flex flex-col justify-between px-1">
                        <div>
                          ...
                          <h3 className="font-heading text-[15px] font-bold text-[#1A3B2E] mb-2 leading-snug line-clamp-2">{post.title}</h3>
            ...
            <div className="bg-[url('/giaynhaurach.png')] bg-cover bg-center p-6 filter drop-shadow-md relative">
              ...
              <div className="space-y-4 relative z-10">
                {leaderboard.length > 0 ? leaderboard.map((u, index) => {
                  ...
                  <p className="text-xs text-center text-stone-500 py-4 italic font-heading">Đang chờ những câu chuyện đầu tiên...</p>
                )}
              </div>
