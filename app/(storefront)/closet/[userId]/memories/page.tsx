...
export default function MemoriesDiaryPage() {
  ...
  const leafY1 = useTransform(scrollYProgress, [0, 1], [0, 200]);
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#EAE4D8] py-8 md:py-16 px-2 sm:px-6 relative overflow-x-hidden selection:bg-[#183A2D] selection:text-white font-sans">
      ...
      >
        ...
        <motion.div style={{ y: leafY1 }} className="absolute top-8 -left-4 md:left-6 w-32 h-40 opacity-70 pointer-events-none z-10 pressed-flora -rotate-12">
        ...
        <motion.div style={{ y: leafY2 }} className="absolute bottom-12 -right-4 md:right-10 w-40 h-48 opacity-60 pointer-events-none z-10 pressed-flora rotate-12">
        ...
        <div className="w-full relative z-20 p-6 sm:p-10 md:p-16">
          ...
          <div className="columns-1 md:columns-2 gap-16 md:gap-32">
            ...
            <motion.div 
              ...
              className="break-inside-avoid mb-14 relative z-10"
            >
              ...
              memories.map((mem, idx) => {
                ...
                return (
                  <motion.div 
                    ...
                    transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1], delay: (idx % 2) * 0.1 }}
                    className={`break-inside-avoid mb-16 relative transition-transform duration-500 hover:z-30 ${currentRotation}`}
                  >
